QuasarinstallDocumentation
=========================

**archinstall** is a library which can be used to install QuasarLinux.
The library comes packaged with different pre-configured installers, such as the default :ref:`guided` installer.

Some of the features of Quasarinstallare:
...
* **Accessibility friendly** Quasarinstallworks with ``espeakup`` and other accessibility tools thanks to the use of a TUI.
...
.. toctree::
   :maxdepth: 3
   :caption: Quasarinstallas a library
