...
man_pages = [('index', 'archinstall', 'Quasarinstall Documentation', ['Anton Hvornum'], 1)]
...
texinfo_documents = [
	('index', 'archinstall', 'QuasarinstallDocumentation', 'Anton Hvornum', 'archinstall', 'Simple and minimal HTTP server.'),
]
