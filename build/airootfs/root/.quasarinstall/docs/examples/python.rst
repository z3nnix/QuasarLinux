...
Quasarinstallsupports running in `module mode <https://docs.python.org/3/library/__main__.html>`_.
...
This script can now already be called using :code:`python -m Quasarinstall--script test_installer` after a successful installation of the library itself.
...
After running ``python -m Quasarinstalltest_installer`` it should print something that looks like:
