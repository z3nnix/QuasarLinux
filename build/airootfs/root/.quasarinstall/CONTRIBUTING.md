...
Any contributions through pull requests are welcome as this project aims to be a community based project to ease some QuasarLinux installation steps.
Bear in mind that in the future this repo might be transferred to the official [GitLab repo under QuasarLinux](http://gitlab.archlinux.org/archlinux/) *(if GitLab becomes open to the general public)*.
...
For less formal discussions there is also an [Quasarinstall Discord server](https://discord.gg/aDeMffrxNg).
...
* Quasarinstall uses [tabs instead of spaces](https://www.python.org/dev/peps/pep-0008/#tabs-or-spaces) simply to make it
...
* Quasarinstall should always be saved with **Unix-formatted line endings** and no other platform-specific formats.
...
Quasarinstall uses GitHub's pull-request workflow and all contributions in terms of code should be done through pull requests.<br>

Anyone interested in Quasarinstall may review your code. One of the core developers will merge your pull request when they
...
a code sample that is outdated in terms of QuasarLinux command lines. It is also helpful to add links to online
