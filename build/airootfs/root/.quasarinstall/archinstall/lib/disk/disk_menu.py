	...
	match result.type_:
		...
		case ResultType.Selection:
			...
			if selection == pre_mount_mode:
				...
				output += tr("WARNING: Quasarinstall won't check the suitability of this setup")
...
async def suggest_multi_disk_layout(
	...
	if home_device is None or root_device is None:
		...
		text += tr('Minimum capacity for QuasarLinux partition: {}GiB').format(desired_root_partition_size.format_size(Unit.GiB))
