...
Quasarinstallsupports multiple languages, which depend on translations coming from the community :)
...
Quasarinstallvalidates this by making sure your passwords are ASCII compatible.
...
After that you're all ready to go and enjoy Quasarinstallin the new language :)
