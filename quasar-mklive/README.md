...
# The Quasar Linux live image/rootfs generator and installer

## Overview

This repository contains several utilities:

* [*mklive.sh*](#mklivesh) - The Quasar Linux live image generator for x86
* [*mkiso.sh*](#mkisosh) - Wrapper script to generate bootable and installable live
  images for i686, x86_64, and aarch64.
* [*mkrootfs.sh*](#mkrootfssh) - The Quasar Linux rootfs generator for all platforms
* [*mkplatformfs.sh*](#mkplatformfssh) - The Quasar Linux filesystem tool to produce
  a rootfs for a particular platform
* [*mkimage.sh*](#mkimagesh) - The Quasar Linux image generator for ARM platforms
* [*mknet.sh*](#mknetsh) - Script to generate netboot tarballs for Void
* *installer.sh* - The Quasar Linux el-cheapo installer for x86
...
ROOTFS tarballs contain a basic Quasar Linux root filesystem without a kernel.
These can be useful for doing a [chroot install](https://docs.quasarlinux.org/installation/guides/chroot.html)
or for [chroots and containers](https://docs.quasarlinux.org/config/containers-and-vms/chroot.html).

Use [*mkrootfs.sh*](#mkrootfssh) to generate a Quasar Linux ROOTFS.
...
[*mkplatformfs.sh*](#mkplatformfssh) to generate a Quasar Linux PLATFORMFS.
...
- `live.user` will change the username of the non-root user from the default
  `anon`. The password remains `quasarlinux`.
...
Generates a platform-specific ROOTFS tarball from a generic Quasar Linux ROOTFS
...
Generates a network-bootable tarball from a Quasar Linux ROOTFS generated by mkrootfs.
