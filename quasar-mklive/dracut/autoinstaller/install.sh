...
# These functions pulled from void's excellent quasar-live.sh
VAI_info_msg() {
    printf "\033[1m%s\n\033[m" "$@"
}
...
VAI_welcome() {
    clear
    printf "=============================================================\n"
    printf "================ Quasar Linux Auto-Installer ==================\n"
    printf "=============================================================\n"
}
...
VAI_configure_autoinstall() {
    ...
    case $XBPS_ARCH in
        *-musl)
            xbpsrepository="https://repo-default.quasarlinux.org/current/musl"
            ;;
        *)
            xbpsrepository="https://repo-default.quasarlinux.org/current"
            ;;
    esac
